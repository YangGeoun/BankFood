<template>
        <div class="map_wrap" :style="mapWidth">
            ...
            <div id="menu_wrap" class="bg_white" style="background-color: white; margin: 0;">
                <div class="option " style="height: 100px; width:100%; ">
                    <div>
                        <div style="margin-bottom: 5px;">
                        <img src="@/assets/MAP.png" alt="" style="width: 60px;">
                        <div style="font-weight: bold; margin: 0px; bottom: 0; ; ">BANKMAPS</div>
                        </div>
                        <form onsubmit="searchPlaces(); return false;" style="">
                        <input type="text" v-model="stores.quest" id="keyword" size="25" style="border-radius: 15px; font-weight: bold; text-align: center;"> 
                        <button style="border: 0px; background-color: white;" type="submit"><img src="@/assets/SEARCH.png" alt="" style="width:18px;"></button>
